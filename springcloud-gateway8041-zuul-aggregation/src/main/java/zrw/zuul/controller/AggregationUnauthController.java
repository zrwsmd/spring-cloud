 ...
 * */
@RestController
public class AggregationUnauthController {

	private static final Logger log = LoggerFactory.getLogger(AggregationUnauthController.class);

	@Autowired
	AggregationUnauthService service;

	
	@GetMapping("/unauth/aggregate/{id}")
